...
import { Eye, Edit, RefreshCw, Users, GraduationCap, BookOpen, Phone, Mail, Tag, Hash } from 'lucide-react';
              ...
              >
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-mono text-[#00AEEF] bg-[#E6F6FB] px-2 py-1 rounded border">
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Hash className="h-3 w-3 text-[#00AEEF]" />
                      <span className="text-xs font-mono text-[#00AEEF] bg-[#E6F6FB] px-2 py-1 rounded border">
                        {student.studentId || 'N/A'}
                      </span>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div>
                  ...
                  <span className="ml-1 font-medium">Grade {student.grade || 'N/A'}</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="ml-1 font-medium">{student.phoneNumber}</span>
                </div>
              </div>
